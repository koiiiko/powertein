...
con.connect(function (err) {
  ...
  var articleSchema = "CREATE TABLE article (id INT PRIMARY KEY AUTO_INCREMENT, title VARCHAR(255) NOT NULL, user_id INT NOT NULL, username VARCHAR(50) NOT NULL, image BLOB, content TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP)";
