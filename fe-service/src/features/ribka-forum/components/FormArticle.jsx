      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4 group">
          ...
          >
            {imagePreview ? (
              ...
              <div className="space-y-4">
                <div
                  className="mx-auto w-16 h-16 bg-[#F1F4F9] rounded-lg flex items-center justify-center
        ...
        <div className="pt-6">
          <button
            ...
            className="w-full bg-primary-600 text-white py-3 px-6 
               rounded-lg hover:bg-primary-700 hover:shadow-lg hover:shadow-primary-500/30
