...
const ProteinSearchResult = () => {
  ...
  return (
    <div className="flex flex-row mt-6 bg-primary-50 w-full py-4 px-6 rounded-lg shadow-sm">
                ...
                <Input
                  ...
                  endContent={
                    <div className="pointer-events-none flex items-center">
                      <span className="text-gray-500 text-sm">/100gr</span>
                    </div>
                  }
                />
